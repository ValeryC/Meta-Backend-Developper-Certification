value = 7  # global variable
class A:
    value = 5 
a = A() # a is an object of class A
a.value = 3 # a.value is an instance variable
print(value) # 7
...
class MyFirstClass: 
    ...
    def handlist( philosopher, book):
        # variable + “ wrote the book: ” + variable
        print(philosopher + " wrote the book: " + book)

# Call function handlist()
MyFirstClass.handlist("Sun Tzu", "The Art of War")
...
class MyFirstClass():
    ...
    def hand_list(self, philosopher, book): # self is a reference to the current instance of the class
